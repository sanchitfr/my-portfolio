...
const About = () => (
    <div className='heading-text'>
        ...
        <span><p>I am a tech enthusiast and a web developer with focus on making good looking, efficient web apps with DRY, 
            ...
            I picked up some courses and started learning!
            </p>
            <p>
            </p> 
        </span>              
